...
//            "73a03a","98a03a","cd9637"};
    ...
    private List<CoachClass> list = new ArrayList<CoachClass>();

    /**
     * @param context
     */
    public WordWrapViewStudyContent(Context context) {
        super(context);
    }
     ...
     * @param defStyle
     */
    public WordWrapViewStudyContent(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public WordWrapViewStudyContent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//    }
    ...
    public void setData(List<CoachClass> lables){
        this.list = lables;
    }

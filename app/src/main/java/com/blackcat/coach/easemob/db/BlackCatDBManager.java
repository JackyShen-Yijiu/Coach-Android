...
import com.blackcat.coach.easemob.domain.InviteMessage;
import com.blackcat.coach.easemob.domain.InviteMessage.InviteMesageStatus;
import com.blackcat.coach.easemob.domain.RobotUser;
import com.blackcat.coach.easemob.domain.User;
import com.easemob.util.HanziToPinyin;

public class BlackCatDBManager {
    static private BlackCatDBManager dbMgr = new BlackCatDBManager();
    ...
    public static synchronized BlackCatDBManager getInstance(){
        return dbMgr;
    }

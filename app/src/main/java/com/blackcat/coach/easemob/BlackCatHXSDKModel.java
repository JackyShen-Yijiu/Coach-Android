...
import com.blackcat.coach.easemob.basefunction.DefaultHXSDKModel;
import com.blackcat.coach.easemob.db.BlackCatDBManager;
...
public class BlackCatHXSDKModel extends DefaultHXSDKModel{

    public BlackCatHXSDKModel(Context ctx) {
        super(ctx);
    }
    ...
    public void closeDB() {
        BlackCatDBManager.getInstance().closeDB();
    }

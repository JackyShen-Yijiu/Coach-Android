...
import com.blackcat.coach.easemob.domain.RobotUser;
import com.blackcat.coach.easemob.domain.User;
import com.blackcat.coach.easemob.receiver.CallReceiver;
 ...
 *
 */
public class BlackCatHXSDKHelper extends HXSDKHelper{

    private static final String TAG = "BlackCatHXSDKHelper";
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewMessage:
                    ...
                    if(message.direct == EMMessage.Direct.RECEIVE) {
                        ...
                        try {
                            user.setNick(message.getStringAttribute(Constant.MESSAGE_NAME_ATTR_KEY));
                            user.setAvatar(message.getStringAttribute(Constant.MESSAGE_AVATAR_ATTR_KEY));
                            user.setUserType(message.getIntAttribute(Constant.MESSAGE_USERTYPE_ATR_KEY, 1));
    ...
    protected HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                Map<String,RobotUser> robotMap=((BlackCatHXSDKHelper)HXSDKHelper.getInstance()).getRobotList();
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                try {
                    ...
                    intent.putExtra(Constant.MESSAGE_USERID_ATR_KEY,
                            message.getStringAttribute(Constant.MESSAGE_USERID_ATR_KEY));
                    intent.putExtra(Constant.MESSAGE_AVATAR_ATTR_KEY,
                            message.getStringAttribute(Constant.MESSAGE_AVATAR_ATTR_KEY));
                    intent.putExtra(Constant.MESSAGE_USERTYPE_ATR_KEY,
                            message.getIntAttribute(Constant.MESSAGE_USERTYPE_ATR_KEY));
                    intent.putExtra(Constant.MESSAGE_NAME_ATTR_KEY,
                            message.getStringAttribute(Constant.MESSAGE_NAME_ATTR_KEY));
                    intent.putExtra(Constant.CHAT_FROM_TYPE, Constant.CHAT_FROM_NOTIFY);
                    return intent;
                }catch (Exception e){
                   return null;
                }
    ...
    protected HXSDKModel createModel() {
        return new BlackCatHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((BlackCatHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((BlackCatHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public BlackCatHXSDKModel getModel(){
        return (BlackCatHXSDKModel) hxModel;
    }

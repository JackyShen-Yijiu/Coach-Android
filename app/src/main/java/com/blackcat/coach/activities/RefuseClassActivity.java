...
public class RefuseClassActivity extends BaseActivity implements
        View.OnClickListener {


    RadioGroup mRadioGroup;
    EditText mEtRefuseIntro;
    Button mBtnSubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refuse_class);
        configToolBar(R.mipmap.ic_back);
        initView();
    }

    private void initView(){
        mRadioGroup = (RadioGroup)findViewById(R.id.rg_refuse_reason);
        mEtRefuseIntro = (EditText)findViewById(R.id.et_refuse_intro);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.btn_submit:
                ...
                String cancelcontent = ((EditText)findViewById(R.id.et_refuse_intro)).getText().toString().trim();

...
import com.blackcat.coach.easemob.task.LoadLocalBigImgTask;
import com.blackcat.coach.easemob.utils.ImageCache;
import com.blackcat.coach.easemob.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.mipmap.ic_avatar_small);

...
public class IndexActivity extends BaseActivity implements IKillable,
		MainScreenContainer.OnTabLisener, View.OnClickListener, EMEventListener {
	...
	private void dailyRefreshCheck() {
    }
	...
	private final TagAliasCallback mAliasCallback = new TagAliasCallback() {
	    ...
	    public void gotResult(int code, String alias, Set<String> tags) {
	        ...
	        case 0:
	            ...
	            Log.i(TAG, logs);
	            Once.markDone(DAILY_REFRESH_TAGS);
...
//	            mHandler.sendMessageDelayed(mHandler.obtainMessage(MSG_SET_ALIAS, alias), 1000 * 60);
	...
	/**
	 * Fix the following crash {STACK_TRACE=java.lang.RuntimeException: Unable
	 * to create thumbnail of
	 * {com.qihoo360.mobilesafe/com.qihoo360.mobilesafe.ui.index.MainScreen}:
	 * java.lang.RuntimeException: Canvas: trying to use a recycled bitmap
	 * android.graphics.Bitmap@4a207870 at
	 * android.app.ActivityThread.createThumbnailBitmap
	 * (ActivityThread.java:3308) at
	 * android.app.ActivityThread.handleRequestThumbnail
	 * (ActivityThread.java:3877) at
	 * android.app.ActivityThread.access$3800(ActivityThread.java:157) at
	 * android.app.ActivityThread$H.handleMessage(ActivityThread.java:2135) at
	 * android.os.Handler.dispatchMessage(Handler.java:99) at
	 * android.os.Looper.loop(Looper.java:123) at
	 * android.app.ActivityThread.main(ActivityThread.java:4684) at
	 * java.lang.reflect.Method.invokeNative(Native Method) at
	 * java.lang.reflect.Method.invoke(Method.java:521) at
	 * com.android.internal.os
	 * .ZygoteInit$MethodAndArgsCaller.run(ZygoteInit.java:876) at
	 * com.android.internal.os.ZygoteInit.main(ZygoteInit.java:634) at
	 ...
	 * android.graphics.drawable.BitmapDrawable.draw(BitmapDrawable.java:323) at
	 * android.view.View.draw(View.java:6729) at
	 ...
	 * android.view.ViewGroup.dispatchDraw(ViewGroup.java:1367) at
	 * android.view.View.draw(View.java:6747) at
	 * android.widget.FrameLayout.draw(FrameLayout.java:352) at
	 * com.android.internal
	 * .policy.impl.PhoneWindow$DecorView.draw(PhoneWindow.java:2035) at
	 * android.app.Activity.onCreateThumbnail(Activity.java:1293) at
	 * android.app.
	 * ActivityThread.createThumbnailBitmap(ActivityThread.java:3303)
	 */
	/*

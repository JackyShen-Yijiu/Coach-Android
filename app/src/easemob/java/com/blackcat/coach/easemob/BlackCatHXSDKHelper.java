...
public class BlackCatHXSDKHelper extends HXSDKHelper{
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((BlackCatHXSDKModel) getModel()).getContactList();
        }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((BlackCatHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((BlackCatHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((BlackCatHXSDKModel)getModel()).saveContactList(mList);
    }

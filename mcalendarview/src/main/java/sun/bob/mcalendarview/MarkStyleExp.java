...
public class MarkStyleExp {
    ...
    public static final int chooseColor = Color.rgb(40,121,243);
    public static final int lightGrayColor = Color.rgb(40,121,243);
    ...
    public static Drawable choose = new Drawable() {
        ...
        public void draw(Canvas canvas) {
            canvas.drawCircle(canvas.getWidth() / 3,
                    canvas.getHeight() / 3,
                    canvas.getHeight() / 4,
                    paint);
        }

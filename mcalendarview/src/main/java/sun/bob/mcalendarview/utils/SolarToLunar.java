...
public class SolarToLunar {
     ...
     * cal 　　* @return 　　
     */
    public SolarToLunar(Calendar cal) {
    ...
    public String getLunarDay(String month, String day) {
    ...
    public String toString() {
        ...
        return getLunarDay(chineseNumber[month - 1], getChinaDayString(day));
    }
}
